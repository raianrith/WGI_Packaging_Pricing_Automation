  ...
  const tiers: SolutionTier[] = (doc.tiers ?? [])
    .map((r) => {
      ...
      return {
        ...
        solution_tier_assumption_prerequisites: normOptStr(r.solution_tier_assumption_prerequisites),
        solution_tier_in_scope: normOptStr(r.solution_tier_in_scope),
        solution_tier_out_of_scope: normOptStr(r.solution_tier_out_of_scope),
        solution_tier_final_deliverable: normOptStr(r.solution_tier_final_deliverable),
        solution_tier_how_do_we_get_this_work_done: normOptStr(
          r.solution_tier_how_do_we_get_this_work_done
        ),
        solution_tier_described_to_client: normOptStr(r.solution_tier_described_to_client),
...
> = {
  ...
  tiers: {
    ...
    columns: [
      ...
      { name: "solution_tier_assumption_prerequisites", description: "Assumptions and prerequisites (optional)." },
      { name: "solution_tier_in_scope", description: "In-scope definition (optional)." },
      { name: "solution_tier_out_of_scope", description: "Out-of-scope definition (optional)." },
      { name: "solution_tier_final_deliverable", description: "Final deliverable (optional)." },
      {
