export const APP_BRAND_NAME = "Weidert Group";

/** Global header subtitle (was “Packaging & Pricing Knowledge Vault”). */
export const APP_SCOPE_LABEL = "Solutions Directory";

/** Browser tab / `aria-label` for the brand lockup. */
export const APP_TITLE = `${APP_BRAND_NAME} · ${APP_SCOPE_LABEL}`;
